...
window.addEventListener("load", function(e) {
  ...
  // spotifyApi.setAccessToken('BQA2bB0Y1eoa_DIsIpSCXpCYi-7CAnkgabfoURUtqJxQsw7UdC7jDSCNsTH_1KIVfjqUtpBSIgO4pgNO6ntIVWWMtvlx2tIleo9ttLbu5PIXw50Rm3eSOm8A9KCogcWvBnElyFOWUXfNjq_dRTYhaD5lZJYpfgJRiGGXMAF9RshgWPFSY4RroTqy1ZGQve9arEZq5IB4c3swsVkGZKNSmzwGP73zwxOtMAgXCiCa2TsyVwHZ8v8wHoI6ASct4NhLiZ7cIW3eBVS6TlvC7sY7');

  // spotifyApi.getMyRecentlyPlayedTracks(
  //   {limit:10}
  // ).then(function (data){
  //   console.log('currently playing', data);
  //   // console.log('currently playing', data.items[0].track.external_urls.spotify);
  //   document.querySelector('#spotify').innerHTML += ' ' + '<a href=' +  data.items[0].track.external_urls.spotify + ' target=_\"blank\">' + data.items[0].track.name + '</a>'+ ' by ' + data.items[0].track.artists[0].name;
  // }, function(err){
  //   console.log(err);
  // })
  ...
  /*mobilecheck*/
  if (mobilecheck()) {
    document.getElementById("ab2").setAttribute("href", "images/m/ab-2.gif");
    document.getElementById("ab2").getElementsByTagName('img')[0].setAttribute("src", "images/m/ab-2.gif");

    let anchors = document.getElementsByTagName("a");

    for (let i = 0; i < anchors.length; i++) {
      if (anchors[i].hasAttribute("data-fancybox")) {
        let oldImg = anchors[i].getAttribute("href");
        let newImg = oldImg.substr(0, 7) + "m" + oldImg.substr(8, oldImg.length);
        anchors[i].setAttribute("href", newImg);
      }
    }
  }
});
...
//   }
//   while (material.uniforms.uOffset.value > 0.08);
// });
